...
This data package contains the data that powers the chart ["Life expectancy"](https://ourworldindata.org/grapher/life-expectancy?time=1990..latest&country=BRA~DEU~KOR~JPN~USA~ESP~PRT~ARG~URY~CHL~CHN~ZAF~RUS~MEX&mapSelect=BRA~DEU~KOR~JPN~USA~ESP~PRT~ARG~URY~CHL~CHN~ZAF&overlay=download-data&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website. It was downloaded on September 11, 2025.

### Active Filters

A filtered subset of the full data was downloaded. The following filters were applied:
country: BRA, DEU, KOR, JPN, USA, ESP, PRT, ARG, URY, CHL, CHN, ZAF, RUS, MEX
overlay: download-data
time: 1990..latest
mapSelect: BRA~DEU~KOR~JPN~USA~ESP~PRT~ARG~URY~CHL~CHN~ZAF
